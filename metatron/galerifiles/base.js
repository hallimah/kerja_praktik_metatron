...
g.n=function(a,b,c){a=a.split(".");c=c||g.m;a[0]in c||!c.execScript||c.execScript("var "+a[0]);for(var d;a.length&&(d=a.shift());)!a.length&&g.ka(b)?c[d]=b:c[d]&&c[d]!==Object.prototype[d]?c=c[d]:c=c[d]={}};
...
laa=function(a){var b=za(Ca,"PQ",[]);Ca.PQ=[];var c=b.length;if(0===c)a();else for(var d=0,e=function(){++d===c&&a()},h=0;h<c;h++)b[h](e)};
Ea=function(a){return za(za(Ca,"H",Ba()),a,Ba())};
maa=function(){function a(){e[0]=1732584193;e[1]=4023233417;e[2]=2562383102;e[3]=271733878;e[4]=3285377520;w=r=0}
function b(a){for(var b=k,c=0;64>c;c+=4)b[c/4]=a[c]<<24|a[c+1]<<16|a[c+2]<<8|a[c+3];for(c=16;80>c;c++)a=b[c-3]^b[c-8]^b[c-14]^b[c-16],b[c]=(a<<1|a>>>31)&4294967295;a=e[0];for(var d=e[1],h=e[2],l=e[3],p=e[4],r,w,c=0;80>c;c++)40>c?20>c?(r=l^d&(h^l),w=1518500249):(r=d^h^l,w=1859775393):60>c?(r=d&h|l&(d|h),w=2400959708):(r=d^h^l,w=3395469782),r=((a<<5|a>>>27)&4294967295)+r+p+w+b[c]&4294967295,p=l,l=h,h=(d<<30|d>>>2)&4294967295,d=a,a=r;e[0]=e[0]+a&4294967295;e[1]=e[1]+d&4294967295;e[2]=e[2]+h&4294967295;
...
function d(){var a=[],d=8*w;56>r?c(l,56-r):c(l,64-(r-56));for(var k=63;56<=k;k--)h[k]=d&255,d>>>=8;b(h);for(k=d=0;5>k;k++)for(var p=24;0<=p;p-=8)a[d++]=e[k]>>p&255;return a}
for(var e=[],h=[],k=[],l=[128],p=1;64>p;++p)l[p]=0;var r,w;a();return{reset:a,update:c,digest:d,mw:function(){for(var a=d(),b="",c=0;c<a.length;c++)b+="0123456789ABCDEF".charAt(Math.floor(a[c]/16))+"0123456789ABCDEF".charAt(a[c]%16);return b}}};
...
vaa=function(){var a=[],b=ya(String(g.m.location.href)),c=g.m.__OVERRIDE_SID;null==c&&(c=(new g.ab(window.document)).get("SID"));if(c&&(b=(c=0==b.indexOf("https:")||0==b.indexOf("chrome-extension:"))?g.m.__SAPISID:g.m.__APISID,null==b&&(b=(new g.ab(window.document)).get(c?"SAPISID":"APISID")),b)){var c=c?"SAPISIDHASH":"APISIDHASH",d=String(g.m.location.href);return d&&b&&c?[c,uaa(ya(d),b,a||null)].join(" "):null}return null};
eb=function(a,b,c){b&&0<b.length&&(b=cb(b),c&&0<c.length&&(b+="___"+cb(c)),28<b.length&&(b=b.substr(0,28)+(b.length-28)),c=b,b=za(waa,"_p",Ba()),za(b,c,Ba())[a]=(new Date).getTime(),b=db.r,"function"===typeof b?b(a,"_p",c):b.push([a,"_p",c]))};
...
Kaa=function(a,b,c){rb(function(){var c=b===Da()?za(sb,"_",Ba()):Ba();c=za(Ea(b),"_",c);a(c)},c)};
ub=function(a,b){var c=b||{};"function"==typeof b&&(c={},c.callback=b);Jaa(a,c);var d=a?a.split(":"):[],e=c.h||Haa(),h=za(Ca,"ah",Ba());if(h["::"]&&d.length){for(var k=[],l=null;l=d.shift();){var p=l.split("."),p=h[l]||h[p[1]&&"ns:"+p[0]||""]||e,r=k.length&&k[k.length-1]||null,w=r;r&&r.hint==p||(w={hint:p,features:[]},k.push(w));w.features.push(l)}var E=k.length;if(1<E){var M=c.callback;M&&(c.callback=function(){0==--E&&M()})}for(;d=k.shift();)tb(d.features,c,d.hint)}else tb(d||[],c,e)};
tb=function(a,b,c){function d(a,b){if(E)return 0;vb.clearTimeout(w);M.push.apply(M,V);var d=((sb||{}).config||{}).update;d?d(h):h&&za(Ca,"cu",[]).push(h);if(b){eb("me0",a,S);try{Kaa(b,c,r)}finally{eb("me1",a,S)}}return 1}
a=iaa(a)||[];var e=b.callback,h=b.config,k=b.timeout,l=b.ontimeout,p=b.onerror,r=void 0;"function"==typeof p&&(r=p);var w=null,E=!1;if(k&&!l||!k&&l)throw"Timeout requires both the timeout parameter and ontimeout parameter to be set";var p=za(Ea(c),"r",[]).sort(),M=za(Ea(c),"L",[]).sort(),S=[].concat(p);0<k&&(w=vb.setTimeout(function(){E=!0;l()},k));
var V=kb(a,M);if(V.length){var V=kb(a,p),la=za(Ca,"CP",[]),Aa=la.length;la[Aa]=function(a){function b(){var a=la[Aa+1];a&&a()}
function c(b){la[Aa]=null;d(V,a)&&laa(function(){e&&e();b()})}
if(!a)return 0;eb("ml1",V,S);0<Aa&&la[Aa-1]?la[Aa]=function(){c(b)}:c(b)};
if(V.length){var Jb="loaded_"+Ca.I++;sb[Jb]=function(a){la[Aa](a);sb[Jb]=null};
a=Aaa(c,V,"gapi."+Jb,p);p.push.apply(p,V);eb("ml0",V,S);b.sync||vb.___gapisync?Iaa(a):pb(a)}else la[Aa](gaa)}else d(V)&&e&&e()};
...
g.yb=function(a,b){a.jc?g.ka(void 0)?b.call(void 0):b():(a.Cb||(a.Cb=[]),a.Cb.push(g.ka(void 0)?(0,g.t)(b,void 0):b))};
...
if("undefined"!==typeof a&&!g.Qb()){var b=new a,c={},d=c;b.port1.onmessage=function(){if(g.ka(c.next)){c=c.next;var a=c.Jn;c.Jn=null;a()}};
...
Vc=function(a,b,c,d){var e=Sc(null,null,null);e.C=new g.Pc(function(a,k){e.D=b?function(c){try{var e=b.call(d,c);a(e)}catch(r){k(r)}}:a;
e.F=c?function(b){try{var e=c.call(d,b);!g.ka(e)&&b instanceof g.bd?k(b):a(e)}catch(r){k(r)}}:k});
...
g.ed=function(a,b,c){if(g.ua(a))c&&(a=(0,g.t)(a,c));else if(a&&"function"==typeof a.handleEvent)a=(0,g.t)(a.handleEvent,a);else throw Error("Invalid listener argument");return 2147483647<Number(b)?-1:g.m.setTimeout(a,b||0)};
g.fd=function(a){g.m.clearTimeout(a)};
g.gd=function(a,b,c){g.wb.call(this);this.C=a;this.D=b||0;this.F=c;this.wc=(0,g.t)(this.Jk,this)};
...
g.Bd=function(a,b){this.x=g.ka(a)?a:0;this.y=g.ka(b)?b:0};
...
se=function(a){return!g.ka(a)||a instanceof re?a:new re(a)};
...
Ef=function(a,b,c,d){d=Te((0,g.t)(d,a.F));d={target:b,name:c,ze:d};b.addEventListener(c,d.ze,void 0);a.C.push(d)};
...
"d"==a.charAt(0))e=(0,window.parseInt)(a.substr(1),10)||0;a=[c,d,e]}else a=[0,0,0];this.F=b;b=a;this.major=b[0];this.minor=b[1];this.C=b[2];if(0>=this.major){if(g.If)try{var k=new window.ActiveXObject("ShockwaveFlash.ShockwaveFlash")}catch(w){k=null}else{var l=window.document.body;var p=window.document.createElement("object");p.setAttribute("type","application/x-shockwave-flash");k=l.appendChild(p)}if(k&&"GetVariable"in k)try{var r=k.GetVariable("$version")}catch(w){r=""}l&&p&&l.removeChild(p);(k=
...
b.dc&&0<b.timeout&&(p=g.af(function(){l||(l=!0,r.abort(),g.Ze(p),b.dc.call(b.context||g.m,r))},b.timeout));
return r};
...
c=void 0===c?"GET":c;d=void 0===d?"":d;var p=mba();if(!p)return null;"onloadend"in p?p.addEventListener("loadend",l,!1):p.onreadystatechange=l;p.open(c,a,!0);h&&(p.responseType=h);k&&(p.withCredentials=!0);c="POST"==c;if(e=nba(a,e))for(var r in e)p.setRequestHeader(r,e[r]),"content-type"==r.toLowerCase()&&(c=!1);c&&p.setRequestHeader("Content-Type","application/x-www-form-urlencoded");p.send(d);return p};
g.gg=function(a,b,c,d,e){c={name:c||g.B("INNERTUBE_CONTEXT_CLIENT_NAME",1),version:d||g.B("INNERTUBE_CONTEXT_CLIENT_VERSION",void 0)};e=window&&window.yterr||e||!1;if(a&&e&&!(5<=eg)){d=a.stacktrace;var h=a.columnNumber;a=g.hd(a);d=d||a.stack;e=a.lineNumber.toString();(0,window.isNaN)(e)||(0,window.isNaN)(h)||(e=e+":"+h);if(!(fg[a.message]||0<=d.indexOf("/YouTubeCenter.js")||0<=d.indexOf("/mytube.js"))){h=a.fileName;b={Ba:{a:"logerror",t:"jserror",type:a.name,msg:a.message.substr(0,1E3),line:e,level:b||
"ERROR"},ka:{url:g.B("PAGE_NAME",window.location.href),file:h},method:"POST"};d&&(b.ka.stack=d);for(var k in c)b.ka["client."+k]=c[k];if(k=g.B("LATEST_ECATCHER_SERVICE_TRACKING_PARAMS",void 0))for(var l in k)b.ka[l]=k[l];g.I("/error_204",b);fg[a.message]=!0;eg++}}};
...
tba=function(a,b,c,d){var e={path:Eg(a.D.innertubeApiVersion,b,c),headers:{"X-Goog-Visitor-Id":g.B("VISITOR_DATA")},method:"POST",body:g.de(c)},h=(0,g.t)(a.G,a);Fg.then(function(){h();g.q("gapi.client.request")(e).execute(d||g.pa)})};
...
g.Ug=function(a){g.qf(a.F);a.F=g.pf((0,g.t)(a.init,a))};
g.Xg=function(a){a.name in Vg&&Wg(a.name);Vg[a.name]={reqs:[],disable:(0,g.t)(a.disable,a)};(0,g.x)(a.deps,function(b){if(!(b in Vg))throw Error("Module "+b+" required by "+a.name);Vg[b].reqs.push(a.name)});
a.enable()};
...
c["all_"+h]=k.join()}delete b[e]}h=!!c.ap;if(k=g.q("ytglobal.timingReportbuilder_")){if(k=k(b,c,a))Nh(k,h),vh(a)}else{var l=g.B("CSI_SERVICE_NAME","youtube");k={v:2,s:l,action:g.B((a||"")+"TIMING_ACTION",void 0)};var p=c.srt;void 0!==b.srt&&delete c.srt;if(c.h5jse){var r=window.location.protocol+g.q("ytplayer.config.assets.js");(r=Bh.getEntriesByName?Bh.getEntriesByName(r)[0]:null)?c.h5jse=Math.round(c.h5jse-r.responseEnd):delete c.h5jse}b.aft=Hh(a);Dba(a)&&"youtube"==l&&(Ch("yt_lt","hot_bg",a),l=
b.vc,r=b.pbs,delete b.aft,c.aft=Math.round(r-l));for(var w in c)"_"!=w.charAt(0)&&(k[w]=c[w]);b.ps=(0,g.ug)();c={};w=[];for(e in b)"_"!=e.charAt(0)&&(l=Math.round(b[e]-d),c[e]=l,w.push(e+"."+l));k.rt=w.join(",");(b=g.q("ytdebug.logTiming"))&&b(k,c);Nh(k,h,a);g.lh(Eba,new mh(c.aft+(p||0),a))}}};
...
Iba=function(){var a=window.location.protocol,b=Bh.getEntriesByType("resource"),c=g.Sa(b,function(b){return 0==b.name.indexOf(a+"//fonts.googleapis.com/css?family=")}),b=(0,g.Vh)(b,function(b){return 0==b.name.indexOf(a+"//fonts.gstatic.com/s/")}),b=(0,g.Wh)(b,function(a,b){return b.duration>a.duration?b:a},{duration:0});
...
ai=function(a,b){g.wb.call(this);this.J=this.G=a;this.ea=b;this.O=!1;this.api={};this.gb=this.X=null;this.ia=new g.ne;g.Ab(this,this.ia);this.D={};this.W=this.ib=this.F=this.Ab=this.C=null;this.na=!1;this.N=this.K=this.H=this.ma=null;this.nb={};this.fc=["onReady"];this.ua=new Df(this);g.Ab(this,this.ua);this.Xc=null;this.Tb=window.NaN;this.Ya={};Zh(this);this.Vd("onDetailedError",(0,g.t)(this.AG,this));this.Vd("onTabOrderChange",(0,g.t)(this.Uv,this));this.Vd("onTabAnnounce",(0,g.t)(this.un,this));
this.Vd("WATCH_LATER_VIDEO_ADDED",(0,g.t)(this.EG,this));this.Vd("WATCH_LATER_VIDEO_REMOVED",(0,g.t)(this.FG,this));g.$h||(this.Vd("onMouseWheelCapture",(0,g.t)(this.mG,this)),this.Vd("onMouseWheelRelease",(0,g.t)(this.nG,this)));this.Vd("onAdAnnounce",(0,g.t)(this.un,this));this.V=new Df(this);g.Ab(this,this.V);this.Cc=!1;this.qb=null};
...
ei=function(a){var b=a.C&&a.C.args&&a.C.args.fflags;if(b&&0<=b.indexOf("web_player_disable_flash=true"))return!1;if(!g.ka(a.C.disable.flash)){var b=a.C.disable;var c=g.Jf.getInstance().isSupported(a.C.minVersion);b.flash=!c}return!a.C.disable.flash};
...
gi=function(a,b){if(!a.ob()){if(!b){var c;if(!(c=!a.C.html5&&ei(a))){if(!g.ka(a.C.disable.html5)){c=!0;void 0!=a.C.args.deviceHasDisplay&&(c=a.C.args.deviceHasDisplay);if(2.2==ii)var d=!0;else{a:{var e=c;c=g.q("yt.player.utils.videoElement_");c||(c=g.Rd("VIDEO"),g.n("yt.player.utils.videoElement_",c,void 0));try{if(c.canPlayType)for(var e=e?Nba:Oba,h=0;h<e.length;h++)if(c.canPlayType(e[h])){d=null;break a}d="fmt.noneavailable"}catch(k){d="html5.missingapi"}}d=!d}d&&(d=ji(a)||a.C.assets.js);a.C.disable.html5=
...
Zh=function(a){a.O=!1;if(a.gb)for(var b in a.D)a.gb(b,a.D[b]);for(var c in a.Ya)g.Ze((0,window.parseInt)(c,10));a.Ya={};a.X=null;a.gb=null;for(var d in a.api)a.api[d]=null;a.api.addEventListener=(0,g.t)(a.Vd,a);a.api.removeEventListener=(0,g.t)(a.bL,a);a.api.destroy=(0,g.t)(a.dispose,a);a.api.getLastError=(0,g.t)(a.tx,a);a.api.getPlayerType=(0,g.t)(a.Mx,a);a.api.getCurrentVideoConfig=(0,g.t)(a.Vw,a);a.api.loadNewVideoConfig=(0,g.t)(a.Vm,a);a.api.isReady=(0,g.t)(a.PM,a)};
...
g.qi=function(a,b){a=g.ma(a)?g.Ed(a):a;b=g.Hf(b);var c=g.oi+"_"+g.xa(a),d=g.pi[c];if(d)return d.Vm(b),d.api;d=new ai(a,c);g.pi[c]=d;g.F("player-added",d.api);g.yb(d,g.u(Qba,d));g.af(function(){d.Vm(b)},0);
return d.api};
Qba=function(a){g.pi[a.getId()]=null};
g.ri=function(a){a=g.z(a);if(!a)return null;var b=g.oi+"_"+g.xa(a),c=g.pi[b];c||(c=new ai(a,b),g.pi[b]=c);return c.api};
...
return b});
g.Ij=g.Ij||{};g.m=this;wa="closure_uid_"+(1E9*Math.random()>>>0);daa=0;g.ue=Date.now||function(){return+new Date};/*
 gapi.loader.OBJECT_CREATE_TEST_OVERRIDE &&*/
var vb=window,mb=window.document,kaa=vb.location,jaa=/\[native code\]/,sb=za(vb,"gapi",{});var Ca;Ca=za(vb,"___jsl",Ba());za(Ca,"I",0);za(Ca,"hel",10);g.v(g.Fa,Error);g.Fa.prototype.name="CustomError";var oaa,paa,qaa,raa,saa,taa,naa;g.Na=String.prototype.trim?function(a){return a.trim()}:function(a){return a.replace(/^[\s\xa0]+|[\s\xa0]+$/g,"")};
...
return e};
g.Wh=Array.prototype.reduce?function(a,b,c,d){d&&(b=(0,g.t)(b,d));return Array.prototype.reduce.call(a,b,c)}:function(a,b,c,d){var e=c;
...
g.f.set=function(a,b,c,d,e,h){if(/[;=\s]/.test(a))throw Error('Invalid cookie name "'+a+'"');if(/[;\r\n]/.test(b))throw Error('Invalid cookie value "'+b+'"');g.ka(c)||(c=-1);e=e?";domain="+e:"";d=d?";path="+d:"";h=h?";secure":"";c=0>c?"":0==c?";expires="+(new Date(1970,1,1)).toUTCString():";expires="+(new Date((0,g.ue)()+1E3*c)).toUTCString();this.C.cookie=a+"="+b+e+d+c+h};
...
g.Yg=new g.ab("undefined"==typeof window.document?null:window.document);g.Yg.F=3950;var db=za(Ca,"perf",Ba());za(db,"g",Ba());var waa=za(db,"i",Ba());za(db,"r",[]);Ba();Ba();var gb=Ba(),qb=[];qb.push(["jsl",function(a){for(var b in a)if(Object.prototype.hasOwnProperty.call(a,b)){var c=a[b];"object"==typeof c?Ca[b]=za(Ca,b,[]).concat(c):za(Ca,b,c)}if(b=a.u)a=za(Ca,"us",[]),a.push(b),(b=/^https:(.*)$/.exec(b))&&a.push("http:"+b[1])}]);
...
g.f.hasListener=function(a,b){return this.wd.hasListener(g.ka(a)?String(a):void 0,b)};zc.prototype.get=function(){if(0<this.F){this.F--;var a=this.C;this.C=a.next;a.next=null}else a=this.D();return a};g.dk=g.Bc(null);var Lc;var Ic=new zc(function(){return new Ec},function(a){a.reset()},100);
...
g.f.start=function(a){this.stop();this.wb=g.ed(this.wc,g.ka(a)?a:this.D)};
...
g.f.Bb=g.ba(4);g.f.Y=function(){g.ne.M.Y.call(this);this.clear();this.D.length=0};g.pe.prototype.set=function(a,b){g.ka(b)?this.C.set(a,g.de(b)):this.C.remove(a)};
...
qe.prototype.F=function(a){a=qe.M.get.call(this,a);if(!g.ka(a)||a instanceof Object)return a;throw"Storage: Invalid value was encountered";};
qe.prototype.get=function(a){if(a=this.F(a)){if(a=a.data,!g.ka(a))throw"Storage: Invalid value was encountered";}else a=void 0;return a};g.v(g.te,qe);g.te.prototype.set=function(a,b,c){if(b=se(b)){if(c){if(c<(0,g.ue)()){g.te.prototype.remove.call(this,a);return}b.expiration=c}b.creation=(0,g.ue)()}g.te.M.set.call(this,a,b)};
...
g.Jf.prototype.isSupported=function(a,b,c){a="string"==typeof a?a.split("."):[a,b,c];a[0]=(0,window.parseInt)(a[0],10)||0;a[1]=(0,window.parseInt)(a[1],10)||0;a[2]=(0,window.parseInt)(a[2],10)||0;return this.major>a[0]||this.major==a[0]&&this.minor>a[1]||this.major==a[0]&&this.minor==a[1]&&this.C>=a[2]};g.Mf=window.yt&&window.yt.msgs_||window.ytcfg&&window.ytcfg.msgs||{};g.n("yt.msgs_",g.Mf,void 0);var Xf=g.ka(window.XMLHttpRequest)?function(){return new window.XMLHttpRequest}:g.ka(window.ActiveXObject)?function(){return new window.ActiveXObject("Microsoft.XMLHTTP")}:null;var Zf;Zf={"X-Goog-Visitor-Id":"SANDBOXED_VISITOR_ID","X-YouTube-Client-Name":"INNERTUBE_CONTEXT_CLIENT_NAME","X-YouTube-Client-Version":"INNERTUBE_CONTEXT_CLIENT_VERSION","X-Youtube-Identity-Token":"ID_TOKEN","X-YouTube-Page-CL":"PAGE_CL","X-YouTube-Page-Label":"PAGE_BUILD_LABEL","X-YouTube-Variants-Checksum":"VARIANTS_CHECKSUM"};g.nk=ag;var fg={},eg=0;var qba,vg,kg;qba={log_event:"events",log_interaction:"interactions"};vg=Object.create(null);vg.log_event="GENERIC_EVENT_LOGGING";vg.log_interaction="INTERACTION_LOGGING";g.sg={};kg={};g.qg=0;g.rg=g.q("ytLoggingTransportLogPayloadsQueue_")||{};g.n("ytLoggingTransportLogPayloadsQueue_",g.rg,void 0);var lg=g.q("ytLoggingTransportTokensToCttTargetIds_")||{};g.n("ytLoggingTransportTokensToCttTargetIds_",lg,void 0);var tg=g.q("ytLoggingTransportDispatchedStats_")||{};
...
g.Hg.prototype.F=function(a,b,c){g.B("VISITOR_DATA")||g.Se(Error("Missing VISITOR_DATA when sending innertube request."));var d={headers:{"Content-Type":"application/json","X-Goog-Visitor-Id":g.B("VISITOR_DATA","")},ka:b,gs:"JSON",dc:c.dc,Z:function(a,b){c.Z&&c.Z(b)},
...
Hba="ap c cver ei yt_fss yt_li".split(" "),Kba={ad_to_ad:"LATENCY_ACTION_AD_TO_AD",ad_to_video:"LATENCY_ACTION_AD_TO_VIDEO",browse:"LATENCY_ACTION_BROWSE",channels:"LATENCY_ACTION_CHANNELS","channel.analytics":"LATENCY_ACTION_CREATOR_CHANNEL_ANALYTICS","channel.videos":"LATENCY_ACTION_CREATOR_CHANNEL_VIDEOS",embed:"LATENCY_ACTION_EMBED",home:"LATENCY_ACTION_HOME",library:"LATENCY_ACTION_LIBRARY",live:"LATENCY_ACTION_LIVE",results:"LATENCY_ACTION_RESULTS",search:"LATENCY_ACTION_RESULTS",video_to_ad:"LATENCY_ACTION_VIDEO_TO_AD",
watch:"LATENCY_ACTION_WATCH","watch,watch7":"LATENCY_ACTION_WATCH","watch,watch7_html5":"LATENCY_ACTION_WATCH","watch,watch7ad":"LATENCY_ACTION_WATCH","watch,watch7ad_html5":"LATENCY_ACTION_WATCH","video.analytics":"LATENCY_ACTION_CREATOR_VIDEO_ANALYTICS","video.comments":"LATENCY_ACTION_CREATOR_VIDEO_COMMENTS"},Gba=["isNavigation","isMonetized","prerollAllowed","isRedSubscriber","isVisible"],Aba=(0,g.t)(Bh.clearResourceTimings||Bh.webkitClearResourceTimings||Bh.mozClearResourceTimings||Bh.msClearResourceTimings||
Bh.oClearResourceTimings||g.pa,Bh);g.v(ai,g.wb);var Mba=["drm.unavailable","fmt.noneavailable","html5.missingapi","html5.unsupportedads","html5.unsupportedlive"];g.f=ai.prototype;g.f.getId=function(){return this.ea};
g.f.Vm=function(a,b){this.ob()||(ci(this,a),gi(this,b),this.O&&di(this))};
g.f.Vw=function(){return this.Ab};
g.f.BM=function(){if(!this.na){var a=ji(this);if(a&&"html5"==li(this))this.W="html5",this.O||this.vg();else if(ni(this),this.W="html5",a&&this.H)this.G.appendChild(this.H),this.vg();else{this.C.loaded=!0;var b=!1;this.ma=(0,g.t)(function(){b=!0;var a=this.G,d=this.C.clone();g.q("yt.player.Application.create")(a,d);this.vg()},this);
...
this.D[e]);di(this);this.ib&&this.ib(this.api);this.ia.oa("onReady",this.api)}else this.Tb=g.af((0,g.t)(this.vg,this),50)}};
